start = '''
You wake up one morning and find Alex and Lily standing infront of an abandoned Bart building. 
...
Pangs of hurt travle from your knees up your spine. You need to make the screaming stop how will you do it?
...
if user_input == "left":
    ...
    print("You choose to go towards the cliff and you find Alex standing in fornt of the cliff. Shocked and worried you made the wrong choice you blink and tap Alex's shoulder. She does not move but says grimly "it depeneds... what is more important to you your memory or finding out the truth about Lily?"")
    print("Type 'left' to find out the truth about Lily or 'right' to regain your memory.")
    user_input = input()
    if user_input == "left": 
        print("you watch as the cliff givesway to a passage way Alex turns and continues through the passage way and you follow closely behind. You walk together with a sort of determined air about you. Neither one of you talk in the damp passage ways but instead you remain silent. You still feel sharp pangs through your spin and leaning down you pause to catch your breath. Alex comes back around saying 'That will happen to you, you have to keep moving no matter what... let's go'")
        print ("you continue to follow Alex through the damp passages wondering where you are, you want to ask Alex but from the pase of the steps it seems as though you guys are running from something.")
        print("As you guys continue to run you realize that what you guys have been running from is the mist. You turn and look at Alex too confirm this. It was true as Alex avoided any place that held the thick substance.")
        print("Alex stops abrupty she drops down... they... they know. You must go on without me... go find Lily as fast as you can... I need to conceal myself")
        print("The strong objection that came from you only upset Alex, you will get us both killed! You have to go now, do not stop and should you stop know you will have the same fate as Lily...go!")
        print("You watched as Alex burried herself in some bushes and plants and sat perfectly still as if she was one with the Earth, you promise to come back for her and continue on marking a place to remember where she is")
        print("Type 'left' to go left or type 'straight' to go straight")
    user_input = input()
    if user_input == "left":
        print("You continue you on but find nothing except some broken bushes... you can't go back to Alex and you can't escape those "them" whoever they are so you are stuck")
        done = True
    elif user_input == "straight"
        print("You continue on this damp passage without Alex, how are you supposed to find Lily? The answer you know is that you never will, but there are people still chasing after you")
        print("as you continue along you pick up your pace as you feel a soft wind blow constantly against your back, who is that? What is that? As you continue you reacha dead end")
        print("Turning to face your fate you let out one final cry begging the familiar face to stop who knew that at of all those years together it would come to this")
      print ("the end"_)
          done = True 
    elif user_input == "right" 
        print("Swiftly Alex swivles you around and you feel a tight pang in you suddenly you fall to the ground. Looking up with shock and confusion you find Alex staring down at you you try to scream but Alex silences you "Its not worth it in order for you to regain all that you have lost you must learn to become what you are not." Fearful your eyes begain to droop as you drift in and out of conciousness")
